...
# Workflow: Dynamic Full-Stack Orchestrator

## 0. Configuration
- **Project Root**: `./` (Relative Path)
- **Roles**: Server(`B1`), Client(`B2`)
- **Initialization**: Remove old status files (`*.status`, `*.done`, `*.fail`, `work_scope.txt`).

## Step 1: Analysis & Scoping (Architect)
- **Action**: [Execute Workflow] **`01_agent_architect.md`**
...
- **Action**: [Execute Workflow] **`05_agent_reporter.md`**