...
PROMPTS: Dict[str, str] = {
    "class_doc": dedent(
        ...
        **출력 형식:**
        - `## Overview` 섹션: 클래스 책임과 대표 사용 시나리오를 5문장 이내로 요약합니다. 문장과 문장사이는 부드럽게 연결됩니다.
    ...
    "method_doc": dedent(
        ...
        **출력 형식:**
        - `## **[Purpose]**` 섹션: 메서드의 의도와 호출 흐름을 5문장     이내로 요약합니다. 문장과 문장사이에 부드럽게 연결하세요.
    ...
    "sql_batch_doc": dedent(
        ...
        **중요: 출력 형식을 정확히 따라야 합니다!**
        ...
        ---SQL#1---
        ### **[Operation]**
        - 수행하는 CRUD 목적과 데이터 흐름을 5문장 이내로 설명합니다. 문장과 문장사이에 부드럽게 연결하세요.
    ...
    "method_batch_doc": dedent(
        ...
        **중요: 출력 형식을 정확히 따라야 합니다!**
        ...
        ---Method#1---
        ###  **[Purpose]**
        - 메서드의 의도와 호출 흐름을 5문장 이내로 요약합니다. 문장과 문장사이에 부드럽게 연결하세요.
