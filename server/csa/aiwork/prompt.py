...
PROMPTS: Dict[str, str] = {
    "class_doc": dedent(
        ...
        **출력 형식:**
        - `## Overview` 섹션: 클래스 책임과 대표 사용 시나리오를 10문장 이내로 요약합니다.
        ...
        - 'Overview' 섹션은 'Overview' 단어를 포함하지 마세요. 그리고 한문장이 끝나면 빈 줄을 추가하세요.
        - 'Key Responsibilities', 'Integrations', 'Additional Insights' 단어는 강조표시('**[단어]**')와 '[' ,']'로 감싸서 기술합니다. 
        - 각 문장 앞에는 '- '로 시작합니다.
    ...
    "sql_doc": dedent(
        ...
        **출력 형식:**
        - `### Operation` 섹션: 수행하는 CRUD 목적과 데이터 흐름을 3문장 이내로 설명합니다.
        ...
        - 'Operation', 'Tables & Conditions', 'Considerations' 각 섹션 사이는 빈 줄과 '---'로 구분합니다.
        - 'Operation' 'Tables & Conditions' 'Considerations' 단어는 강조표시('**[단어]**')와 '[' ,']'로 감싸서 기술합니다. 
    ...
    "sql_batch_doc": dedent(
        ...
        **중요: 출력 형식을 정확히 따라야 합니다!**
        ...
        ---SQL#1---
        ### **[Operation]**
        - 수행하는 CRUD 목적과 데이터 흐름을 5문장 이내로 설명합니다.
        - 예시: 사용자 ID를 기준으로 단일 레코드를 조회하는 SELECT 문입니다.
        - 각 문장사이에 빈 줄을 추가합니다.
        ---
        ### **[Tables & Conditions]**
        - 주요 테이블, 조인 조건, 필터를 불릿 목록으로 정리합니다.
        - 예시: 
            - 테이블: users
            - 조건: id = #userId
        ---
    ...
    "method_batch_doc": dedent(
        ...
        **중요: 출력 형식을 정확히 따라야 합니다!**
        ...
        ---Method#1---
        ###  **[Purpose]**
        - 메서드의 의도와 호출 흐름을 5문장 이내로 요약합니다.
        - 예시: 사용자 ID를 받아서 데이터베이스에서 사용자 정보를 조회합니다.
        ---
        ### **[Inputs & Outputs]**
        - 파라미터, 반환값, 부작용을 불릿 목록으로 명시합니다.
        - 예시: 
            - 입력: userId (Long 타입)
            - 반환: User 객체
        ...
        ---
        ### **[Important Details]**
        - 예외 처리, 성능 고려, 동시성, 호출 의존성 등을 불릿으로 정리합니다.
        - 예시: 
