"""
Java 프로젝트 스트리밍 모드 파싱 모듈.

파일을 병렬로 파싱하고 즉시 Neo4j에 저장하여 메모리 사용량을 최소화합니다.
"""
...
from csa.models.graph_entities import Package
from csa.services.graph_db import GraphDB
from csa.utils.logger import get_logger
from csa.utils.i18n import _t
from .config import extract_config_files
from .mybatis import extract_mybatis_xml_mappers, extract_sql_statements_from_mappers
from .single_file_parser import parse_single_java_file
from .project_orchestration import _collect_java_files_with_csaignore
