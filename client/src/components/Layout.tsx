                ...
                <nav className="flex-1 px-3 py-6 space-y-2 overflow-y-auto custom-scrollbar overflow-x-hidden">
                    ...
                    <div className={`rounded-xl overflow-hidden transition-all duration-300 mb-1 ${(location.pathname === '/' || location.pathname.startsWith('/projects')) && !isCollapsed ? 'bg-slate-800/50' : ''}`}>
                        ...
                        <div className={`pl-11 pr-4 pb-2 space-y-1 ${isCollapsed ? 'hidden' : 'block'}`}>
                            ...
                            <Link
                                to="/classes"
                                className={`flex items-center px-4 py-2 text-sm rounded-lg transition-all duration-200 group ${location.pathname.startsWith('/classes')
                                    ? 'bg-indigo-500/10 text-indigo-400'
                                    : 'text-slate-400 hover:bg-slate-700/50 hover:text-white'
                                    }`}
                            >
                            ...
                            <Link
                                to="/mappers"
                                className={`flex items-center px-4 py-2 text-sm rounded-lg transition-all duration-200 group ${location.pathname.startsWith('/mappers')
                                    ? 'bg-indigo-500/10 text-indigo-400'
                                    : 'text-slate-400 hover:bg-slate-700/50 hover:text-white'
                                    }`}
                            >
                                <span className="w-1.5 h-1.5 rounded-full bg-current mr-2 opacity-50 group-hover:opacity-100" />
                                <span className="whitespace-nowrap">{t('mapperList.title')}</span>
                            </Link>
                            <Link
                                to="/sqls"
                            ...
                            >
                                <span className="w-1.5 h-1.5 rounded-full bg-current mr-2 opacity-50 group-hover:opacity-100" />
                                <span className="whitespace-nowrap">{t('sqlList.title')}</span>
                            </Link>
                        </div>
                    </div>
                        ...
                        <>
                            ...
                            <div className={`rounded-xl overflow-hidden transition-all duration-300 ${isGroupActive('/admin') && !isCollapsed ? 'bg-slate-800/50' : ''}`}>
                                ...
                                <div className={`pl-11 pr-4 pb-2 space-y-1 ${isCollapsed ? 'hidden' : 'block'}`}>
                                    ...
                                    <Link
                                        to="/rules"
                                        className={`flex items-center px-4 py-2 text-sm rounded-lg transition-all duration-200 group ${isActive('/rules')
                                            ? 'bg-indigo-500/10 text-indigo-400'
                                            : 'text-slate-400 hover:bg-slate-700/50 hover:text-white'
                                            }`}
                                    >
                                        <span className="w-1.5 h-1.5 rounded-full bg-current mr-2 opacity-50 group-hover:opacity-100" />
                                        <span className="whitespace-nowrap">{t('rules.title')}</span>
                                    </Link>
                                    <Link
                                        to="/admin/ai-prompts"
