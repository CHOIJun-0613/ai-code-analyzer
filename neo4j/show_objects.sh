#!/bin/bash
echo "=== 1. 데이터베이스 확인 ==="
cypher-shell -a bolt://localhost:7687 -u neo4j -p neo4j123 "SHOW DATABASES;"

echo -e "\n=== 2. 사용자 확인 ==="
cypher-shell -a bolt://localhost:7687 -u neo4j -p neo4j123 -d system "SHOW USERS;"

echo -e "\n=== 3. 노드 현황 ==="
cypher-shell -a bolt://localhost:7687 -u csaadmin -p "#csapass123" -d refinerdb \
